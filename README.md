# Oscar Alicicco | Growth & Editoria 📚📊

Questo è il repository del mio sito web professionale. Il progetto presenta il mio profilo ibrido di **Growth Specialist & Senior Editor**, unendo oltre 15 anni di esperienza nel settore editoriale con competenze avanzate di **Data Analysis**.
...
👉 [https://oscaralic.github.io/sito/](https://oscaralic.github.io/sito/)

## 📸 Screenshot
Ecco un'anteprima della home page del sito:
...
├── curriculum.html      # Pagina del CV completo
├── README.md            # Documentazione del progetto
└── assets/              # Risorse del sito
    ├── css/
    │   └── style.css    # Fogli di stile
    └── img/
        └── ...          # Immagini, copertine e screenshot
